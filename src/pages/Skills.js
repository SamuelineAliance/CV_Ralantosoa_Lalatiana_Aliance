                    ...
                    <div className="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                        <div className="progress-wrap">
                            ...
                            <div className="progress">
                                ...
                                aria-valuemin="0" aria-valuemax="100" width="75%">
                                <span>75%</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 animate-box" data-animate-effect="fadeInRight">
                        <div className="progress-wrap">
                            ...
                            <div className="progress">
                                ...
                                aria-valuemin="0" aria-valuemax="100" width="60%">
                                <span>60%</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                        <div className="progress-wrap">
                            ...
                            <div className="progress">
                                ...
                                aria-valuemin="0" aria-valuemax="100" width="85%">
                                <span>85%</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 animate-box" data-animate-effect="fadeInRight">
                        <div className="progress-wrap">
                            ...
                            <div className="progress">
                                ...
                                aria-valuemin="0" aria-valuemax="100" width="90%">
                                <span>90%</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 animate-box" data-animate-effect="fadeInLeft">
                        <div className="progress-wrap">
                            ...
                            <div className="progress">
                                ...
                                aria-valuemin="0" aria-valuemax="100" width="70%">
                                <span>70%</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-md-6 animate-box" data-animate-effect="fadeInRight">
                        <div className="progress-wrap">
                            ...
                            <div className="progress">
                                ...
                                aria-valuemin="0" aria-valuemax="100" width="80%">
                                <span>80%</span>
                                </div>
                            </div>
                        </div>
